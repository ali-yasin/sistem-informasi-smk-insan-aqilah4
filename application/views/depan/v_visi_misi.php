...
<head>
    ...
    <title>SMK Insan Aqilah 4 - Visi Misi</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <h2>Visi dan Misi</h2>
                <b><h5>Visi</h5></b>
                <p>Terwujudnya lingkungan yang agamis, berbudi pekerti luhur dan unggul dalam prestasi</p>

                <h5>Misi</p>
                <p>1. Melaksanakan pengembangan kurikulum</p>
                <p>2. Melaksanakan pembelajaran dan bimbingan konseling secara efektif, setiap siswa dapat berkembang secara optimal sesuai dengan potensi masing-masing.</p>
                <p>3. Melaksanakan pengembangan dan peningkatan standar ketuntasan dan kelulusan.</p>
                <p>4. Melaksanakan pengembangan tenaga kependidikan.</p>
                <p>5. Melaksanakan rencana induk pengembangan fasilitas Pendidikan.</p>
                <p>6. Melaksanakan manajemen berbasis sekolah dan peningkatan mutu kelembagaan.</p>
                <p>7. Melaksanakan program penggalangan pembiayaan sekolah.</p>
                <p>8. Melaksanakan pengembangan penilaian.</p>
                <p>9. Mewujudkan lingkungan sekolah yang bernuansa agamis.</p>

                </div>
                <div class="col-md-5">
                    <img src="<?php echo base_url().'theme/images/logo aqilah.png'?>" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-md-12">
                    <div class="single-item">
                        <div class="quote">
                            ...
                            <p class="quote_text">Tujuan pendidikan adalah untuk menggantikan pikiran yang kosong dengan pikiran yang terbuka.</p>
                            <div class="testi-img_block">
                                <img src="<?php echo base_url().'theme/images/'?>" class="img-fluid" alt="">
                                
                            </div>
                        </div>
                        <div class="quote">
                            <i class="fa fa-quote-left" aria-hidden="true"></i>
                            <p class="quote_text">Semakin sulit perjuangannya, semakin besar kemenangannya.</p>
                            <div class="testi-img_block">
                                <img src="<?php echo base_url().'theme/images/student-2.'?>" class="img-fluid" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="address">
                                <h3>Hubungi Kami</h3>
                                <p><span>Alamat: </span>Jl. Penerangan 1A, Petamburan, Jakarta Barat. 114600</p>
